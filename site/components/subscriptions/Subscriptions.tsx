  ...
  return (
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        <div className={`flex gap-3 ${showChannelInfo ? '' : 'justify-between'}`}>
          {showChannelInfo && (
            <Avatar className="w-9 h-9 flex-shrink-0">
              <AvatarFallback className="font-semibold text-black">{video.uploader.username[0].toUpperCase()}</AvatarFallback>
            </Avatar>
          )}
